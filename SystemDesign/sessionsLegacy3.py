...
# + 30-minute Optional DDIA chapters (visible sub-events).

weeks = [
    # -------------------------------------------------
    # Week 1 — Bit.ly, Dropbox, Rate Limiter (+ DDIA)
    # -------------------------------------------------
    [
        {
        ...
        },
        {
            ...
            "slots": [
                ...
                ("Artifacts: Quick diagram cleanup", 10),
                ("Optional Reading: DDIA Ch.5 (Replication → Dropbox sync & durability)", 30),
            ],
        },
        {
    ...
    # Core DDIA: Ch.6 (Partitioning), Ch.8 (Distributed Systems Trouble)
    # ----------------------------------------------------
    [
        {
    ...
    # Core DDIA: Ch.10 (Batch), Ch.11 (Streams)
    # ----------------------------------------------------
    [
        {
        ...
        },
        {
            ...
            "slots": [
                ...
                ("Optional Reading: DDIA Ch.10 (Batch Processing → offline aggregation)", 30),
            ],
        },
        {
        ...
        },
        {
            ...
            "slots": [
                ...
                ("Optional Reading: DDIA Ch.11 (Stream Processing → events, exactly-once-ish)", 30),
            ],
        },
        {
    ...
    # Core DDIA: Ch.2 (Data Models), Ch.9 (Consensus/Consistency)
    # ----------------------------------------------------
    [
        {
        ...
        },
        {
            ...
            "slots": [
                ...
                ("Optional Reading: DDIA Ch.2 (Data Models & Query Languages → index design)", 30),
            ],
        },
        {
        ...
        },
        {
            ...
            "slots": [
                ...
                ("Optional Reading: DDIA Ch.9 (Consistency & Consensus → coordination/OT/CRDTs)", 30),
            ],
        },
        {
    ...
    # Core DDIA: Ch.4 (Encoding & Evolution), Ch.12 (Future of Data Systems)
    # ----------------------------------------------------
    [
        {
            ...
            "slots": [
                ...
                ("Optional Reading: DDIA Ch.4 (Encoding & Evolution → schema/index evolution)", 30),
            ],
        },
        {
        ...
        },
        {
            ...
            "slots": [
                ...
                ("Optional Reading: DDIA Ch.12 (Future of Data Systems → recsys/feeds)", 30),
            ],
        },
        {
    ...
    # Core DDIA: Ch.7 (Transactions), Ch.9 (Consistency/Consensus)
    # ----------------------------------------------------
    [
        {
            ...
            "slots": [
                ...
                ("Optional Reading: DDIA Ch.9 (Consistency & Consensus → coordination/locks)", 30),
            ],
        },
        {
        ...
        },
        {
            ...
            "slots": [
                ...
                ("Optional Reading: DDIA Ch.7 (Transactions → atomicity/isolation)", 30),
            ],
        },
        {
    ...
    # Core DDIA: Ch.8 (Trouble with Distributed Systems), Ch.9 (Consensus)
    # ----------------------------------------------------
    [
        {
            ...
            "slots": [
                ...
                ("Optional Reading: DDIA Ch.8 (Trouble with Distributed Systems → time, faults)", 30),
            ],
        },
        {
    ...
    # Core DDIA: Ch.1 (Reliable, Scalable, Maintainable Apps)
    # ----------------------------------------------------
    [
        {
